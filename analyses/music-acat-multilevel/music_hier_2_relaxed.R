...
cat("Starting Music Relaxed CS Model...\n")
...
formula_mod <- bf(
  rating_ord ~ 1 + cs(educ_c) + cs(social_c) + cs(economic_c) + income_c + age_c + gend.f + race.f + (1 | respondent_id) + (1 | genre)
)
